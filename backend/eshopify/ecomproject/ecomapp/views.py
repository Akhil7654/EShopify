...
from ecomapp.serializer import ProductsSerializer,UserSerializer,UserSerializerWithToken
...
@api_view(['GET'])
def getProduct(request, pslug):
    try:
        product = Products.objects.get(slug=pslug)
